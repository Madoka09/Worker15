# Generated by Django 3.0.4 on 2020-09-24 03:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0010_agreement_product'),
    ]

    operations = [
        migrations.CreateModel(
            name='ProductsInvestor',
            fields=[
                ...
                ('created_by', models.ForeignKey(db_column='created_by', on_delete=django.db.models.deletion.PROTECT, related_name='ProductsInvestorCreatedBy', to=settings.AUTH_USER_MODEL)),
                ('deactivated_by', models.ForeignKey(db_column='deactivated_by', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='ProductsInvestorDeactivateddBy', to=settings.AUTH_USER_MODEL)),
